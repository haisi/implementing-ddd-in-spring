...
class ArchitectureTests {
    ...
    /**
     * @see <a href="https://docs.spring.io/spring-modulith/reference/verification.html">Verifying Application Module Structure</a>
     */
    ...
    void writeDocumentationSnippets() {
        ...
        new Documenter(modules)
                .writeModuleCanvases()
                .writeModulesAsPlantUml(Documenter.DiagramOptions.defaults().withStyle(Documenter.DiagramOptions.DiagramStyle.C4))
