...
public class Transition<T extends Serializable> implements Serializable {
  ...
  public static <T extends Serializable> InitializedTransitionBuilder<T> initialState(
      T initialState) {
  ...
  public <E extends Exception> T evaluateTransition(T fromState, Supplier<E> errorToThrow)
      throws E {
